...
import { QUERY } from 'src/components/Restaurant/RestaurantsCell'
        ...
        <tbody>
          {restaurants.map((restaurant) => (
            <tr key={restaurant.id}>
              <td>{truncate(restaurant.id)}</td>
              <td>{truncate(restaurant.name)}</td>
              <td>
                <nav className="rw-table-actions">
                  <Link
                    to={routes.restaurant({ id: restaurant.id })}
                    title={'Show restaurant ' + restaurant.id + ' detail'}
                  ...
                  <Link
                    ...
                    title={'Edit restaurant ' + restaurant.id}
                  ...
                  <button
                    type="button"
                    title={'Delete restaurant ' + restaurant.id}
